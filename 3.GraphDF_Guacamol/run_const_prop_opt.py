...
if args.train:
    ...
    mols_0, mols_2, mols_4, mols_6 = runner.run_const_prop_opt(dataset, conf['model'], args.model_path, 1, conf['min_optim_time'], conf['num_max_node'], conf['temperature'], conf['atom_list'])
    print(mols_0)
